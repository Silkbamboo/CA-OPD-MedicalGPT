"""Minimal, CPU-runnable OPD / CA-OPD training loop (PROJECT_PLAN.md §14 Phase 0).
...
The formal Phase 1-3 stack is veRL + vLLM (PROJECT_PLAN.md §6). This module is
...
class TeacherRegistry:
    ...
    Mirrors the GPU-1 design (PROJECT_PLAN.md §11.5): the *same* backbone object
...
def save_checkpoint(
    ...
    would silently break run comparability (PROJECT_PLAN.md §15).
    """
