...
#: Which source pool each destination draws from.
DESTINATION_POOL: Mapping[str, str] = {
    ...
    "general_anchors": "general_mcq",
}

POOLS: Tuple[str, ...] = ("medical_reasoning", "medical_mcq", "general_mcq")
...
DATA_SCHEMA: Dict[str, object] = {
    ...
    "sources": {
        ...
        "medical_mcq": FieldSpec((list,), doc="medical MCQ source specs (controller dev + final test)"),
        "general_mcq": FieldSpec((list,), doc="general MCQ source specs (anchors + dev + test)"),
    },
    "allocation": {
